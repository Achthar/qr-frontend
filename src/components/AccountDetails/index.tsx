...
import { ExternalLink, LinkStyledButton } from 'theme/components'
                      ...
                      <div>
                        ...
                        {chainId && account && (
                          <AddressLink
                            hasENS={!!ENSName}
                            isENS={true}
                            href={chainId && getNetworkExplorerLink(ENSName, "address", chainId)}
                          >
                            <LinkIcon size={16} />
                      ...
                      <div>
                        ...
                        {chainId && account && (
                          <AddressLink
                            hasENS={!!ENSName}
                            isENS={false}
                            href={getNetworkExplorerLink(ENSName, "address", chainId)}
                          >
                            <LinkIcon size={16} />
                            <span style={{ marginLeft: '4px' }}>{t('accountDetails.viewExplorer')}</span>
                          </AddressLink>
