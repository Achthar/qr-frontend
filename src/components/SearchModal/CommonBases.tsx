...
import { Currency, currencyEquals, ETHER, Token, NETWORK_CCY } from '@pancakeswap/sdk'
  ...
  return (
    <AutoColumn gap="md">
      ...
      <AutoRow gap="auto">
        <BaseWrapper
          onClick={() => {
            if (!selectedCurrency || !currencyEquals(selectedCurrency, NETWORK_CCY[chainId])) {
              onSelect(NETWORK_CCY[chainId])
            }
          }}
