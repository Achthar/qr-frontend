...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  [ChainId.BSC_MAINNET]: 'https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v3',
  [ChainId.AVAX_MAINNET]: 'https://api.thegraph.com/subgraphs/name/uniswap/uniswap-v3',

  [ChainId.AVAX_TESTNET]: 'https://api.thegraph.com/subgraphs/name/ianlapham/uniswap-arbitrum-one',

  [ChainId.MATIC_TESTNET]: 'https://api.thegraph.com/subgraphs/name/ianlapham/uniswap-optimism-dev',
}
