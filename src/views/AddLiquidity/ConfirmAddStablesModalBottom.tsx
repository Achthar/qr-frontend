...
function ConfirmAddStablesModalBottom({
  chainId,
  price,
  currencies,
  parsedAmounts,
  ...
  noLiquidity?: boolean
  price?: Fraction
  currencies: { [field in StablesField]?: Currency }
  parsedAmounts: { [field in StablesField]?: CurrencyAmount }
...
export default ConfirmAddStablesModalBottom
