              ...
              <CardBody>
                ...
                {account && (
                  <Flex alignItems="center" mb="8px">
                    ...
                    <LinkExternal href={getNetworkExplorerLink(account, 'address')}>{truncateHash(account)}</LinkExternal>
                  </Flex>
                )}
                <Flex alignItems="center" mb="16px">
                  ...
                  <LinkExternal href={getNetworkExplorerLink(snapshot, 'block')}>{snapshot}</LinkExternal>
                </Flex>
                {account ? (
                  <>
                    <Button
