...
export const redeemCallNote = async (chainId, account, bondDepositoryContract, noteIndex) => {
...
export const startCallBonding = async (chainId, account, bondDepositoryContract, bondId, amount, maxPrice) => {
  const gasPrice = getGasPrice(chainId)
...
export const claimCallReward = async (chainId, bondDepositoryContract) => {
  const gasPrice = getGasPrice(chainId)
