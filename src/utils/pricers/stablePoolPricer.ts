...
import { StablePool, Token } from "@requiemswap/sdk";
...
export function getTotalValue(_swap: StablePool, _quote: Token): BigNumber {
...
export function stablePoolValuation(
    _swap: StablePool,
    _quote: Token,
    _amount: BigNumber,
    _supply: BigNumber
...
export function markdown(_swap: StablePool, _quote: Token): BigNumber {
